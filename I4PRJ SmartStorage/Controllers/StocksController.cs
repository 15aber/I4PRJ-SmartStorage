...
namespace I4PRJ_SmartStorage.Controllers
{
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StockId,InventoryId,ProductId,Quantity,LastUpdated,ByUser,Version")] Stock stock)
        {
            if (ModelState.IsValid)
            {
                //stock.LastUpdated = DateTime.Now;
                //stock.ByUser = User.Identity.Name;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StockId,InventoryId,ProductId,Quantity,LastUpdated,ByUser,Version")] Stock stock)
        {
            if (ModelState.IsValid)
            {
                //stock.LastUpdated = DateTime.Now;
