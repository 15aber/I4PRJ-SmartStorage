/// <reference path="dataTables.autoFill.js" />
/*! AutoFill 2.1.2
 ...
 */
    ...
    $.extend(AutoFill.prototype,
    {
        ...
        _focusListener: function() {
            ...
            var focus = this.c.focus !== null ? this.c.focus : dt.settings()[0].keytable ? 'focus' : 'hover';

            // All event listeners attached here are removed in the `destroy`
            // callback in the constructor
            if (focus === 'focus') {
                dt
                    .on('key-focus.autoFill',
                        function(e, dt, cell) {
                            that._attach(cell.node());
                        })
                    .on('key-blur.autoFill',
                        function(e, dt, cell) {
                            that._detach();
                        });
            } else if (focus === 'click') {
