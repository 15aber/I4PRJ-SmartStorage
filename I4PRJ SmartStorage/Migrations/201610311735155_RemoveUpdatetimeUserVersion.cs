namespace I4PRJ_SmartStorage.Migrations
{
    ...
    public partial class RemoveUpdatetimeUserVersion : DbMigration
    {
        ...
        {
            AddColumn("dbo.Transactions", "Version", c => c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"));
            ...
            AddColumn("dbo.Inventories", "Version", c => c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"));
